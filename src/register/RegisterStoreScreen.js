...
// @inject('rootStore')
// @observer
export default class RegisterStoreScreen extends Component {
  // 静态属性，设置title
  ...
  componentDidMount() {
    ...
    console.log('========  username   99999 ======= ', username);
  ...
  doRegister = () => {
    ...
    console.log('provider/store/register', JSON.stringify({
      // id: this.state.id.value,
      // name: this.state.name.value,
      // password: this.state.password.value,
      // provider: this.state.provider.value,
      // type: "STORE"
      username: this.state.id.value,
      name: this.state.name.value,
      password: this.state.password.value,
    }));
    const {
    ...
    if (this.doValidate()) {
      ...
      fetch(BASE_URL + 'provider/store/register', {
        method: 'POST',
        headers: {
          ...
          <Row>
            <Col style={{ alignItems: "center" }}>
              <Button
                ...
                buttonStyle={{ borderRadius: 10, width: 170, marginTop: 0 }}
                title="OK"
                onPress={this.doDone}
              />
            </Col>
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <Row style={{ height: 20 }} />
          <Row style={{ height: 60, marginLeft: 20, marginRight: 30 ,display : 'none' }}>
            <Col>
              <TextField
                autoCapitalize="none"
                autoCorrect={false}
          ...
          >
            ...
            <Button
              ...
              buttonStyle={{ borderRadius: 10, width: width - 60, height: 44, backgroundColor: "#1F707A", }}
              title={"Register"}
